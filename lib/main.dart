...
class _MyHomePageState extends State<MyHomePage> {
  ...
  _MyHomePageState() {
    ...
    Place place2 = Place(
        id: "2",
        name: "Estábulo",
        imageUrl: "lib/assets/est.jpg",
        animals: [
          Cow("02", "Anita", "00", "aa", "bb", "cc", "dd", 123, "2222", 1233,
              1422, "Padrão")
        ]);
    Place place3 = Place(
        id: "3",
        name: "Galinheiro",
        imageUrl: "lib/assets/gal.jpg",
        animals: [
          Cow("03", "Gloria", "00", "aa", "bb", "cc", "dd", 123, "2222", 1233,
              1422, "Padrão")
        ]);

    myPlaces.addLocation(place1);
    myPlaces.addLocation(place2);
    myPlaces.addLocation(place3);
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: ListPlaces(
                  myPlaces, ModalRoute.of(context)!.settings.name as String),
            ),
            Padding(
